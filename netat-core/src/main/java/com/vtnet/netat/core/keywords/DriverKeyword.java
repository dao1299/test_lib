...
//
//            // Đọc execution.type từ config để quyết định factory (giống startBrowser)
...
//    }
//
//    // Helper method để validate session name
...
//    }
//
//    // Helper method để validate web platform (nếu chưa có)
//    private void validateWebPlatform(String platform, String methodName) {
//        if (platform == null || platform.trim().isEmpty()) {
//            throw new IllegalArgumentException(
//                    "Platform cannot be null/empty for " + methodName);
//        }
//        if (MOBILE_PLATFORMS.contains(platform.toLowerCase())) {
//            throw new IllegalArgumentException(
//                    "Invalid platform '" + platform + "' for " + methodName +
//                            ". This is a mobile platform. Use mobile-specific methods instead.");
//        }
//    }
//
//    @NetatKeyword(
